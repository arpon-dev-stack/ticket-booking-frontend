...
import { convertToLocal } from '../utils/dateFormater';
                                    ...
                                    <div className="grid grid-cols-1 mob:grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                                        <div className="flex items-start text-gray-600">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-blue-600 font-semibold">{convertToLocal(bus.departure.date)}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start text-gray-600">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600 font-semibold">{convertToLocal(bus.arrival.date)}</p>
